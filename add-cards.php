...
if( isset($_POST['btn-card']) ) {
  ...
  $cardbrand = strip_tags($cardbrand);
  $cardbrand = htmlspecialchars($cardbrand);
  ...
  $cardissuer = trim($_POST['cardissuer']);
  $cardissuer = strip_tags($cardissuer);
  $cardissuer = htmlspecialchars($cardissuer);

  $cardcategory = trim($_POST['cardcategory']);
  $cardcategory = strip_tags($cardcategory);
  $cardcategory = htmlspecialchars($cardcategory);

  $expiration = trim($_POST['expiration']);
  $expiration = strip_tags($expiration);
  $expiration = htmlspecialchars($expiration);

  $availableinfo = trim($_POST['availableinfo']);
  $availableinfo = strip_tags($availableinfo);
  $availableinfo = htmlspecialchars($availableinfo);
...
$item_id = generateRandomString();
  ...
  $result = db_query("INSERT INTO cards(Country,Item_id,Card_brand,Card_type,Numbers,Card_issuer,Card_category,Card_expiration,Available_info,Price,Seller) VALUES('$country','$item_id','$cardbrand','$cardtype','$number','$cardissuer','$cardcategory','$expiration','$availableinfo','$price','$seller')");
  if ($result == 1) {
...
<div class="app-content content container-fluid">
      ...
      <div class="content-header row">
       <div class="content-header-left col-md-6 offset-md-3 mb-1">
            <h2 class="content-header-title">Add Cards</h2>
        </div>
      </div>
          ...
          <div class="col-md-6 offset-md-3">
            ...
            <form class="form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
              <div class="form-body">
                ...
                <div class="form-group">
                   <label>Country</label>
                      ...
                      <input type="text" id="" class="form-control" placeholder="Card Brand" name="cardbrand">
                    </div>

                      <div class="form-group">
                      <label for="">Card Type</label>
                      <input type="text" id="" class="form-control" placeholder="Card Type" name="cardtype">
                    </div>
                      ...
                      <div class="form-group">
                      <label for="">Card Issuer</label>
                      <input type="text" id="" class="form-control" placeholder="Card Issuer" name="cardissuer">
                    </div>

                    <div class="form-group">
                      <label for="">Card Category</label>
                      <input type="text" id="" class="form-control" placeholder="Card Category" name="cardcategory">
                    </div>

                    <div class="form-group">
                      <label for="">Expiration</label>
                      <input type="date" id="" class="form-control" placeholder="Expiration" name="expiration">
                    </div>


                <div class="form-group">
                  <label>Available Info</label>
                  <textarea id="" rows="5" class="form-control square" name="availableinfo" placeholder="Available Info"></textarea>
                </div> 
              ...
              <div class="form-actions center">
                <button type="submit" name="btn-card" class="btn btn-primary">
