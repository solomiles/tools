...
$item_id = generateRandomString();
  ...
  $result = db_query("INSERT INTO smtps(Country,Item_id,Webmail,Hosting,Price,Seller) VALUES('$country','$item_id','$webmail','$hostingowner','$price','$seller')");
  if ($result == 1) {
...
<div class="app-content content container-fluid">
      ...
      <div class="content-header row">
       <div class="content-header-left col-md-6 offset-md-3 mb-1">
            <h2 class="content-header-title">Add SMTPS</h2>
        </div>
      </div>
          ...
          <div class="col-md-6 offset-md-3">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title">Add SMTPS</h5>
            ...
            <form class="form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
              <div class="form-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="" class="form-control" placeholder="Webmail" name="webmail">
                </div>
              ...
              <div class="form-actions center">
                <button type="submit" name="btn-smtps" class="btn btn-primary">
