...
// die($country);
 ...
 $name = ($_FILES["image"] ["name"]);
  ...
  $hostingowner = trim($_POST['hostingowner']);
  $hostingowner = strip_tags($hostingowner);
  $hostingowner = htmlspecialchars($hostingowner);
...
if ($error > 0){
  ...
  $result = db_query("INSERT INTO cpanels(Country,Item_id,Cpanel_ssl,TLD,Type,Hosting,Price,Seller) VALUES('$country','$item_id','$ssl','$tld','$name','$hostingowner','$price','$seller')");
...
<div class="content-header row">
       <div class="content-header-left col-md-6 offset-md-3 mb-1">
            <h2 class="content-header-title">Add Cpanels / WHM</h2>
        </div>
      </div>
          ...
          <div class="col-md-6 offset-md-3">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title">Add Cpanels / WHM</h5>
            ...
            <form class="form" enctype='multipart/form-data' method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
              <div class="form-body">
                ...
                <div class="form-group">
                   <label>Country</label>
                      ...
                      <div class="form-group">
                    <label>Type <small>(Upload Image)</small></label>
                  <input type="file" id="" class="form-control" placeholder="" name="image">
                </div>
              ...
              <div class="form-group">
                  <label for="">Hosting Owner</label>
                  <input type="text" id="" class="form-control" placeholder="Hosting Owner" name="hostingowner">
                </div>
              ...
              <div class="form-actions center">
                <button type="submit" name="btn-cpanel" class="btn btn-primary">
                      ...
                      <tbody>
                        <?php $ok = mysqli_fetch_assoc(show_table()) ?>
                          ...
                          <tr>
                              ...
                              <td><img src="image/<?php echo $row['Type']; ?>" width="50" height="13"></td>
