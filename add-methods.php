...
$item_id = generateRandomString();
  ...
  $result = db_query("INSERT INTO tutorials(Name,Item_id,Description,Price,Seller) VALUES('$name','$item_id','$description','$price','$seller')");
  if ($result == 1) {
...
function show_table(){
  global $user;
    $result = db_query("SELECT * FROM tutorials WHERE Seller = '$user' ");
    return $result; 
  }
...
<div class="content-header row">
       <div class="content-header-left col-md-6 offset-md-3 mb-1">
            <h2 class="content-header-title">Add Methods/Tutorials</h2>
        </div>
      </div>
          ...
          <div class="col-md-6 offset-md-3">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title">Add Methods/Tutorials</h5>
            ...
            <form class="form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
              ...
              <div class="form-actions center">
                <button type="submit" name="btn-method" class="btn btn-primary">
