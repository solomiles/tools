...
$item_id = generateRandomString();
  ...
  $result = db_query("INSERT INTO mailers(Country,Item_id,TLD,Hosting,Price,Seller) VALUES('$country','$item_id','$tld','$hostingowner','$price','$seller')");
  if ($result == 1) {
...
function show_table(){
  global $user;
    $result = db_query("SELECT * FROM mailers WHERE Seller ='$user'  ");
    return $result; 
  }
...
<div class="content-header row">
       <div class="content-header-left col-md-6 offset-md-3 mb-1">
            <h2 class="content-header-title">Add Mailers</h2>
        </div>
      </div>
          ...
          <div class="col-md-6 offset-md-3">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title">Add Mailers</h5>
            ...
            <form class="form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
              ...
              <div class="form-actions center">
                <button type="submit" name="btn-mailer" class="btn btn-primary">
