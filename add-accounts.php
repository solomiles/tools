...
$item_id = generateRandomString();
  ...
  $result = db_query("INSERT INTO accounts(Country,Item_id,Type,Name,URL,Information,Price,Seller) VALUES('$country','$item_id','$type','$name','$url','$information','$price','$seller')");
  if ($result == 1) {
...
function show_table(){
    global $user;
    $result = db_query("SELECT * FROM accounts WHERE Seller ='$user' ");
    return $result; 
  }
...
<div class="content-header row">
       <div class="content-header-left col-md-6 offset-md-3 mb-1">
            <h2 class="content-header-title">Add Accounts</h2>
        </div>
      </div>
                 ...
                 <div class="form-group">
                   <label>Country</label>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="" class="form-control" placeholder="type" name="type">
                      </div>
                      ...
                      <div class="form-group">
                        <label for="">URL</label>
                        <input type="url" id="" class="form-control" placeholder="URL" name="url">
                      </div>
