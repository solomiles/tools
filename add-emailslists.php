...
$item_id = generateRandomString();
  ...
  $result = db_query("INSERT INTO email_list(Country,Item_id,Description,Numbers,Price,Seller) VALUES('$country','$item_id','$description','$number','$price','$seller')");
  if ($result == 1) {
...
function show_table(){
  global $user;
    $result = db_query("SELECT * FROM email_list WHERE Seller = '$user' ");
    return $result; 
  }
...
<div class="app-content content container-fluid">
 ...
 <div class="content-header row">
       <div class="content-header-left col-md-6 offset-md-3 mb-1">
            <h2 class="content-header-title">Add E-mails List</h2>
        </div>
      </div>
          ...
          <div class="col-md-6 offset-md-3">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title">Add E-mails List</h5>
            ...
            <form class="form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
              ...
              <div class="form-actions center">
                <button type="submit" name="btn-emaillist" class="btn btn-primary">
