...
$item_id = generateRandomString();
  ...
  $result = db_query("INSERT INTO vps(Country,Item_id,OS,Ram,Access,Hosting,Price,Seller) VALUES('$country','$item_id','$os','$ram','$access','$hostingowner','$price','$seller')");
  if ($result == 1) {
...
<div class="content-header row">
       <div class="content-header-left col-md-6 offset-md-3 mb-1">
            <h2 class="content-header-title">Add VPSs (Linux, Windows)</h2>
        </div>
      </div>
          ...
          <div class="col-md-6 offset-md-3">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title">Add VPSs (Linux, Windows)</h5>
            ...
            <form class="form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
              <div class="form-body">
                ...
                <div class="form-group">
                   <label>Country</label>
                      ...
                      <div class="form-group">
                    <label>OS</label>
                  <input type="text" id="" class="form-control" placeholder="" name="os">
                </div>

                  <div class="form-group">
                    <label>Access</label>
                  <input type="text" id="" class="form-control" placeholder="Access" name="access">
                </div>

                <div class="form-group">
                  <label for="">Ram</label>
                  <input type="text" id="" class="form-control" placeholder="Ram" name="ram">
                </div>
              </div>
              ...
              <div class="form-actions center">
                <button type="submit" name="btn-vps" class="btn btn-primary">
